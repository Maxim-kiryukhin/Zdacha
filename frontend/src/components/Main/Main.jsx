    ...
    return (
        <>
            <div className="main">
                ...
                <div className="text">
                    <p className="oswald">Выберите интересующий ресторан</p>
                </div>
                <div className="text_small">
                    <p className="comfortaa">
                        Быстрый ланч, уютный вечер вдвоем, шумные посиделки с
                        компанией. В нашем меню есть всё, чтобы сделать ваш
                        момент особенным.
                    </p>
                </div>
            </div>
            ...
            <div className="main-about_half">
                <div className="first_half">
                    ...
                    <div className="first_half_desc_text">
                        <h1 className="martian-mono">Вкус&Традиция</h1>
                    </div>
                    <button
